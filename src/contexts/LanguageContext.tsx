...
const translations = {
  en: {
    ...
    'hero.headline': 'United We Stand, Together We Thrive.',
    'hero.subtitle': 'ARCC brings together Cameroonians in Canada to support, guide, and empower each other through community, mentorship, and shared resources.',
    'hero.cta.primary': 'Join Our Community',
    'hero.cta.secondary': 'Get Support',
    'hero.trust': 'Over 500+ Cameroonians supported since 2020',
    'hero.banner.option1.headline': 'United We <span class="color-transition-1 font-semibold">Stand</span>, Together We <span class="color-transition-2 font-semibold">Thrive</span>.',
    'hero.banner.option1.subtitle': 'ARCC brings together <span class="color-transition-1 font-semibold">Cameroonians</span> in Canada to support, guide, and empower each other through <span class="color-transition-4 font-semibold">community</span> and shared resources.',
  ...
  fr: {
    ...
    'hero.headline': 'Unis Nous Sommes Plus Forts, Ensemble Nous Réussissons.',
    'hero.subtitle': 'ARCC rassemble les Camerounais au Canada pour se soutenir, se guider et s\'autonomiser mutuellement grâce à la communauté, au mentorat et aux ressources partagées.',
    ...
    'hero.banner.option1.headline': 'Unis Nous <span class="color-transition-1 font-semibold">Sommes</span> Plus Forts, Ensemble Nous <span class="color-transition-2 font-semibold">Réussissons</span>.',
    'hero.banner.option1.subtitle': 'ARCC rassemble les <span class="color-transition-1 font-semibold">Camerounais</span> au Canada pour se soutenir, se guider et s\'autonomiser mutuellement grâce à la <span class="color-transition-4 font-semibold">communauté</span> et aux ressources partagées.',
